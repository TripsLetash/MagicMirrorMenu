...
Overrides = {
    ...
    GlowIndex = {
        "846acbf5-d8b3-4e73-9860-b55375049628",
        "b2c8f751-3bf0-46c2-959c-c0d4d9f70ab8",
        "0706e40c-1dbb-4d72-b49b-99fd3bdcfa55",
        "e343d1f4-f44b-44e7-ac71-bf977893457f",
        "a576b24b-95de-4ef9-844f-12746c677b3e",
        "5b8986d7-c834-4c9e-ac3c-6efe384b94be",
        "624674ef-d83c-453b-b43b-52eebdb2f454",
        "3a2bd1e2-bfcf-4b5d-a939-db7f9f8f9db4",
        "a91b9e97-9fc2-471b-b237-af98bf61a416",
        "7e06b297-1125-4d20-8c93-2a52aa684975",
        "9f0c85f0-0429-4b8d-94fb-acbaa4e0c6c4",
        "453402dd-9214-4749-8f80-625932585c9f",
        "281b47ce-36c9-484c-875e-01728a1f9e04",
        "3b9c60fb-9ffa-4dd7-b564-50bd1ab395c7",
        "7666eb6e-60d1-4e98-9402-ae75458b2f31"
    },
    HeadIndex = {
    ...
    ColorGlow = {
        Black = "5ab6d9fa-1f34-4fdf-a33f-fcd35bed2504",
        Red = "ba13e86a-5d72-48b2-b186-9998818b0a31",
        Orange = "6d3a0ed8-3e13-4b8c-b1ce-cec133e756c8",
        Yellow = "154e907a-f1be-402f-a31d-1c78c0de30af",
        Green = "72421e37-0daa-48f3-8142-955c8e3ee6ce",
        Blue = "493bcf30-5bf7-4b32-852b-8fb1a678be25",
        Purple = "25506141-27e6-4d5d-a215-d5439acbc475",
        Pink = "7145df5d-89a4-4729-b584-7681f94ef066",
        Brown = "3a9a9580-603a-4b22-93f4-3220adc1a5d4",
        White = "b0209705-df04-4366-bf9c-eda797d216af",
        Fallen = "a7747208-6c06-4486-8f72-d4032ed099ad",
        Lightblue = "f9d22816-b88c-4ed1-860c-b45958100c44",
        Peeyellow = "92fc3299-111a-4f42-8b0d-0162e1f3a540",
        Gold = "e8885cc1-9dcd-4107-9713-b3932d440cbe",
        Lightpink = "5f019d24-2bb8-4d78-9168-83e30df7bba8",
        Darkpink = "057d3f54-fa34-4566-8677-f3540da83c00",
        Lightsilver = "0d22996b-394b-4761-9f35-18bf989568ed",
        Darksilver = "009ff18f-19b8-4494-b45d-2bc2b6fa9e7c",
        Lightpurple = "9c517ba8-3e0c-4f58-af8b-258bea359fcf",
        Olive = "806e5a58-5022-4c2a-827c-b47f22df99d3"
    },
    Color1 = {
...
Ext.Events.NetMessage:Subscribe(function(e)
    ...
    if (e.Channel == "Glowmap_Index1") then ApplyOverride(sender, "GlowIndex", 1) end
    if (e.Channel == "Glowmap_Index2") then ApplyOverride(sender, "GlowIndex", 2) end
    if (e.Channel == "Glowmap_Index3") then ApplyOverride(sender, "GlowIndex", 3) end
    if (e.Channel == "Glowmap_Index4") then ApplyOverride(sender, "GlowIndex", 4) end
    if (e.Channel == "Glowmap_Index5") then ApplyOverride(sender, "GlowIndex", 5) end
    if (e.Channel == "Glowmap_Index6") then ApplyOverride(sender, "GlowIndex", 6) end
    if (e.Channel == "Glowmap_Index7") then ApplyOverride(sender, "GlowIndex", 7) end
    if (e.Channel == "Glowmap_Index8") then ApplyOverride(sender, "GlowIndex", 8) end
    if (e.Channel == "Glowmap_Index9") then ApplyOverride(sender, "GlowIndex", 9) end
    if (e.Channel == "Glowmap_Index10") then ApplyOverride(sender, "GlowIndex", 10) end
    if (e.Channel == "Glowmap_Index11") then ApplyOverride(sender, "GlowIndex", 11) end
    if (e.Channel == "Glowmap_Index12") then ApplyOverride(sender, "GlowIndex", 12) end
    if (e.Channel == "Glowmap_Index13") then ApplyOverride(sender, "GlowIndex", 13) end
    if (e.Channel == "Glowmap_Index14") then ApplyOverride(sender, "GlowIndex", 14) end
    if (e.Channel == "Glowmap_Index15") then ApplyOverride(sender, "GlowIndex", 15) end

    if (e.Channel == "ColorGlowButton1") then ApplyOverride(sender, "ColorGlow", "Blue") end
    if (e.Channel == "ColorGlowButton2") then ApplyOverride(sender, "ColorGlow", "Yellow") end
    if (e.Channel == "ColorGlowButton3") then ApplyOverride(sender, "ColorGlow", "Green") end
    if (e.Channel == "ColorGlowButton4") then ApplyOverride(sender, "ColorGlow", "Red") end
    if (e.Channel == "ColorGlowButton5") then ApplyOverride(sender, "ColorGlow", "Pink") end
    if (e.Channel == "ColorGlowButton6") then ApplyOverride(sender, "ColorGlow", "Purple") end
    if (e.Channel == "ColorGlowButton7") then ApplyOverride(sender, "ColorGlow", "White") end
    if (e.Channel == "ColorGlowButton8") then ApplyOverride(sender, "ColorGlow", "Black") end
    if (e.Channel == "ColorGlowButton9") then ApplyOverride(sender, "ColorGlow", "Brown") end
    if (e.Channel == "ColorGlowButton10") then ApplyOverride(sender, "ColorGlow", "Orange") end
    if (e.Channel == "ColorGlowButton11") then ApplyOverride(sender, "ColorGlow", "Fallen") end
    if (e.Channel == "ColorGlowButton12") then ApplyOverride(sender, "ColorGlow", "Lightblue") end
    if (e.Channel == "ColorGlowButton13") then ApplyOverride(sender, "ColorGlow", "Peeyellow") end
    if (e.Channel == "ColorGlowButton14") then ApplyOverride(sender, "ColorGlow", "Gold") end
    if (e.Channel == "ColorGlowButton15") then ApplyOverride(sender, "ColorGlow", "Lightpink") end
    if (e.Channel == "ColorGlowButton16") then ApplyOverride(sender, "ColorGlow", "Darkpink") end
    if (e.Channel == "ColorGlowButton17") then ApplyOverride(sender, "ColorGlow", "Lightsilver") end
    if (e.Channel == "ColorGlowButton18") then ApplyOverride(sender, "ColorGlow", "Darksilver") end
    if (e.Channel == "ColorGlowButton19") then ApplyOverride(sender, "ColorGlow", "Lightpurple") end
    if (e.Channel == "ColorGlowButton20") then ApplyOverride(sender, "ColorGlow", "Olive") end

   -- if (e.Channel == "GlowColorChanged") then Ext.Entity.Replicate(Ext.Entity.Get(sender).GameObjectVisual) end
end)