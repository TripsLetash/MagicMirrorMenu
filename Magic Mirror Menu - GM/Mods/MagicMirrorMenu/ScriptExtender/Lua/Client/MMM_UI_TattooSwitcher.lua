...
IndexPickRow7 = IndexPickTable:AddRow()
...
GlowmapIntSelector = IndexPickRow5:AddCell():AddSliderInt("Glow Tattoo (1-15)", 1, 1, 15)
GlowmapIntSelector.IDContext = "SliderGlowmapIndex"
FaceMakeUpIntSelector = IndexPickRow7:AddCell():AddSliderInt("Make Up (1-16)", 1, 1, 16)
...
tColorTabGlow = tColorTab:AddTabItem("Glow")
tColorTabGlow:SetColor("Tab", {0.2,0.2,0.2,1})
...
tattooColorHeaderGlow = tColorTabGlow:AddCollapsingHeader("Glow Tattoo Colors")
tattooColorHeaderGlow.DefaultOpen = true
...
GlowmapIntSelector.OnChange = function() Ext.Net.PostMessageToServer("Glowmap_Index"..GlowmapIntSelector.Value[1], "OnChange") UpdateCC() end

glowmapButton1.OnClick = function() Ext.Net.PostMessageToServer("ColorGlowButton1", "OnClick") UpdateCC() end
glowmapButton2.OnClick = function() Ext.Net.PostMessageToServer("ColorGlowButton2", "OnClick") UpdateCC() end
glowmapButton3.OnClick = function() Ext.Net.PostMessageToServer("ColorGlowButton3", "OnClick") UpdateCC() end
glowmapButton4.OnClick = function() Ext.Net.PostMessageToServer("ColorGlowButton4", "OnClick") UpdateCC() end
glowmapButton5.OnClick = function() Ext.Net.PostMessageToServer("ColorGlowButton5", "OnClick") UpdateCC() end
glowmapButton6.OnClick = function() Ext.Net.PostMessageToServer("ColorGlowButton6", "OnClick") UpdateCC() end
glowmapButton7.OnClick = function() Ext.Net.PostMessageToServer("ColorGlowButton7", "OnClick") UpdateCC() end
glowmapButton8.OnClick = function() Ext.Net.PostMessageToServer("ColorGlowButton8", "OnClick") UpdateCC() end
glowmapButton9.OnClick = function() Ext.Net.PostMessageToServer("ColorGlowButton9", "OnClick") UpdateCC() end
glowmapButton10.OnClick = function() Ext.Net.PostMessageToServer("ColorGlowButton10", "OnClick") UpdateCC() end
glowmapButton11.OnClick = function() Ext.Net.PostMessageToServer("ColorGlowButton11", "OnClick") UpdateCC() end
glowmapButton12.OnClick = function() Ext.Net.PostMessageToServer("ColorGlowButton12", "OnClick") UpdateCC() end
glowmapButton13.OnClick = function() Ext.Net.PostMessageToServer("ColorGlowButton13", "OnClick") UpdateCC() end
glowmapButton14.OnClick = function() Ext.Net.PostMessageToServer("ColorGlowButton14", "OnClick") UpdateCC() end
glowmapButton15.OnClick = function() Ext.Net.PostMessageToServer("ColorGlowButton15", "OnClick") UpdateCC() end
glowmapButton16.OnClick = function() Ext.Net.PostMessageToServer("ColorGlowButton16", "OnClick") UpdateCC() end
glowmapButton17.OnClick = function() Ext.Net.PostMessageToServer("ColorGlowButton17", "OnClick") UpdateCC() end
glowmapButton18.OnClick = function() Ext.Net.PostMessageToServer("ColorGlowButton18", "OnClick") UpdateCC() end
glowmapButton19.OnClick = function() Ext.Net.PostMessageToServer("ColorGlowButton19", "OnClick") UpdateCC() end
glowmapButton20.OnClick = function() Ext.Net.PostMessageToServer("ColorGlowButton20", "OnClick") UpdateCC() end

-- local payload = {1,0,0}
-- tattooColorFaceButtonSet.OnClick = function() 
--     Ext.Entity.GetAllEntitiesWithComponent("PartyMember")[1].Visual.Visual.Attachments[1].Visual.ObjectDescs[1].Renderable.AppliedMaterials[1].MaterialInstance.Parameters.Vector3Parameters[1].Value = {1,0,0} 
--     Ext.Entity.GetAllEntitiesWithComponent("PartyMember")[1].Visual.Visual.Attachments[1].Visual.ObjectDescs[1].Renderable.AppliedMaterials[1].MaterialInstance.Parameters.Vector3Parameters[1].Enabled = true 
--     Ext.Entity.GetAllEntitiesWithComponent("PartyMember")[1].Visual.Visual.Attachments[1].Visual.ObjectDescs[1].Renderable.AppliedMaterials[1].MaterialInstance.Parameters.Texture2DParameters[2].ID = "b2c8f751-3bf0-46c2-959c-c0d4d9f70ab8"
--     Ext.Entity.GetAllEntitiesWithComponent("PartyMember")[1].Visual.Visual.Attachments[1].Visual.ObjectDescs[1].Renderable.AppliedMaterials[1].MaterialInstance.Parameters.Texture2DParameters[2].Enabled = true 
--     UpdateCC() end
-- tattooColorFaceButtonShow.OnClick = function() Ext.IO.SaveFile("entityDump.json", Ext.DumpExport(Ext.Entity.GetAllEntitiesWithComponent("PartyMember")[1]:GetAllComponents())) end
